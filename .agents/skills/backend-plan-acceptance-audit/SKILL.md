...
description: Independently verify whether selected plans are ready to implement.
---

# backend-plan-acceptance-audit

1. 从仓库根目录完整读取 `.github/prompts/backend-plan-acceptance-audit.prompt.md`。
2. 将该 prompt 作为唯一流程规范，在独立上下文执行计划就绪验收。
