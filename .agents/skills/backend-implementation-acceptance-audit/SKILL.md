...
description: Independently verify whether a plan implementation is complete.
---

# backend-implementation-acceptance-audit

1. 从仓库根目录完整读取 `.github/prompts/backend-implementation-acceptance-audit.prompt.md`。
2. 将该 prompt 作为唯一流程规范，在独立上下文验收实施完成状态。
