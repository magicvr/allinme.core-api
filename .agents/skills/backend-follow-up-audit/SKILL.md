...
description: Independently verify pending remediation records.
---

# backend-follow-up-audit

1. 从仓库根目录完整读取 `.github/prompts/backend-follow-up-audit.prompt.md`。
2. 将该 prompt 作为唯一流程规范，在独立上下文复审 REM，不顺手整改。
