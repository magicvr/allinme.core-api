...
description: Independently audit a completed implementation record.
---

# backend-implementation-audit

1. 从仓库根目录完整读取 `.github/prompts/backend-implementation-audit.prompt.md`。
2. 将该 prompt 作为唯一流程规范，在独立上下文审计 completed IMP。
