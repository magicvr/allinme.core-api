...
description: Audit selected plans and create one AUD per plan.
---

# backend-plan-audit

1. 从仓库根目录完整读取 `.github/prompts/backend-plan-audit.prompt.md`。
2. 将该 prompt 作为唯一流程规范，执行对应计划审计 prompt，只审计不整改。
