...
description: Orchestrate plan audit, remediation, follow-up, and readiness acceptance.
---

# backend-plan-audit-until-ready

1. 从仓库根目录完整读取 `.github/prompts/backend-plan-audit-until-ready.prompt.md`。
2. 将该 prompt 作为唯一流程规范，编排计划审计闭环直到 ready 或明确停止。
