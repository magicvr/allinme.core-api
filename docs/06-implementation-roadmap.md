...
阶段三按三个端到端里程碑实施，详细门禁见[活跃计划](./audit/0003-2026-07-12-plan.md)与[checklist](./audit/0003-2026-07-12-checklist.md)：M1 交付真实登录可用的列表/详情纵切，M2 交付真实 app 中的创建/编辑/幂等纵切，M3 交付履约 Action、CORS、重启/reset 和文档收敛。每个里程碑都必须可启动、可演示、可独立合并和回滚。
