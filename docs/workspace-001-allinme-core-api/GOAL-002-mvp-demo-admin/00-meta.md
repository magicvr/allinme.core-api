...
| **M3b** | 钱包 API + 种子数据 | **进行中（W2 完成）** | [GOAL-006](../GOAL-006-wallet-api/00-meta.md)（50%；W3 HTTP/RBAC 下一步） |
...
- 2026-07-25：GOAL-006 W1 domain/port/service 与接口级测试完成。
- 2026-07-25：GOAL-006 W2 SQLite repository、事务 batch-freeze、事务 seed 与测试完成，子目标 progress 50%，下一步 W3 HTTP/RBAC。
