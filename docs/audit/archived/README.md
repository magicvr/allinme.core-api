...
- `0004` 阶段四退款与经营看板：[plan](./0004-2026-07-13-plan.md) / [checklist](./0004-2026-07-13-checklist.md)。实现 v6 退款 schema、幂等申请、审批/拒绝、订单退款不变量、退款 HTTP 闭环和经营看板；schema-only/旧 v5 binary 回退、fresh-data smoke、全仓 test/vet/race 与文档门禁均通过，PR #4 已 squash 合入 `main@34b58c0`，最终 PR/main push 远端 `test`/`race` CI 均成功。
