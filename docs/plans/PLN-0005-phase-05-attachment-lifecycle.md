...
| WP-Release | P0-16、P0-19、P0-21、P0-22 | release owner / Evidence reviewer | WP-Facts、WP-Schema-Recovery、WP-HTTP-Order、WP-Lock、WP-Baseline-Evidence、WP-Files、WP-Runtime 的已批准输出；可用部署环境 | 2 人日 | 入口/版本矩阵、四发布产物 manifest schema/命令 fixture、支持 profile、逐包重估与 DAG 校验；真实 release artifact 留给 M1A/5A/5B；阶段五协议 owner 批准 |
